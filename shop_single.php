        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src=<?php echo $result['photo'] ?> alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"><?php echo $result['name'] ?></h1>
                            <p class="h3 py-2">$<?php echo $result['price'] ?></p>
                            <p class="py-2">
                                <?php for ($i = 1; $i <= $result['rank']; $i++) { ?>
                                    <i class="fa fa-star text-warning"></i>
                                <?php } ?>
                                <?php for ($i = 1; $i <= 5 - $result['rank']; $i++) { ?>
                                    <i class="fa fa-star text-secondary"></i>
                                <?php } ?>
                                <span class="list-inline-item text-dark">Rating <?php echo $result['rank'] ?> | 36 Comments</span>
                            </p>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?php echo $result['color'] ?></strong></p>
                                </li>
                            </ul>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong id="stock"><?php echo $result['stock'] ?></strong></p>
                                </li>
                            </ul>
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            <li class="list-inline-item text-right">
                                                Quantity
                                                <input type="hidden" name="product-quantity" id="product-quantity" value="">
                                            </li>
